const todoListReducer = (state=[], action) => {
  switch (action.type) {
    ...
    case 'REMOVE_TODOLIST':
      ...
      console.log('action.payload.updateIndex', action.payload.updateIndex)
      console.log('[...state.slice(0,action.payload.updateIndex)', [...state.slice(0,action.payload.updateIndex)])
      console.log('[...state.slice(action.payload.updateIndex+1)', [...state.slice(0,action.payload.updateIndex)])
