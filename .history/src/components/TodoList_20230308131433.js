...
function TodoList() {
  ...
  const {loading, error, todolist, setTodolist, createTodoList, updateTodoList, deleteTodoList} = useGet()
  ...
  const handleEdit = (id,value) => {
    ...
    if(value) {
      let newTodo = {id:id, title:value, isComplete: false}
      ...
      updateTodoList(id, newTodo, updateTodoIndex)
    } else {
