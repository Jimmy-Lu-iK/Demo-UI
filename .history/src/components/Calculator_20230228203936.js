...
export default function Calculator() {
  ...
  return <div className="calculator">
    ...
    <div className="calculator-row">
      ...
      <button className="calculator-button">%</button>
      <button className="calculator-button" onClick={() => handleSelectItem(7)}>/</button>
    </div>
    <div className="calculator-row">
      ...
      <button className="calculator-button" onClick={() => handleSelectItem('x')}>x</button>
    </div>
    <div className="calculator-row">
      ...
      <button className="calculator-button" onClick={() => handleSelectItem('-')}>-</button>
    </div>
    <div className="calculator-row">
